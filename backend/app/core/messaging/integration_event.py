...
class IntegrationEvent(BaseModel):
    ...
    def _extract_module_name(self) -> str:
        ...
        # Extract module name from path like 'app.modules.catalog.domain.events'
...
class EventBus:
    ...
    def register_module_handlers(
        ...
        for event_type, handler in handlers.items():
            ...
            routing_pattern = f"app.{module_name}.{event_type}"
    ...
    def get_routing_key_for_event(self, event_type: str) -> str:
        ...
        return self.routing_patterns.get(event_type, f"app.*.{event_type}")
