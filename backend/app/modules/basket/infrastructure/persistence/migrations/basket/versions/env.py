"""Alembic environment configuration for basket module."""
...
def get_url():
    ...
    return os.getenv("BASKET_DB_URL", config.get_main_option("sqlalchemy.url"))
...
async def run_async_migrations() -> None:
    ...
    async with connectable.connect() as connection:
        # Ensure basket schema exists before running migrations
        await connection.execute(text("CREATE SCHEMA IF NOT EXISTS basket"))
