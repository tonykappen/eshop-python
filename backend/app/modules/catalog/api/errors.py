...
from app.modules.catalog.domain.product.exceptions.product_already_exists import ProductAlreadyExists
from app.modules.catalog.domain.product.exceptions.product_not_found import ProductNotFound
...
async def catalog_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    """
