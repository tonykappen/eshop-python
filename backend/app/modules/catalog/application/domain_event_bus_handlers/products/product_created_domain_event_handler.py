"""Converts ProductCreatedDomainEvent → ProductCreatedIntegrationEvent."""
...
class ProductCreatedDomainEventBusHandler:
    """Converts ProductCreatedDomainEvent to ProductCreatedIntegrationEvent."""
