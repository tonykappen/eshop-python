...
from app.modules.catalog.application.features.product.commands.create_product.command import (
    CreateProductCommand,
)

# Import feature routers
from app.modules.catalog.application.features.product.commands.create_product.endpoint import (
    router as create_product_router,
)

# Import handlers for registration
from app.modules.catalog.application.features.product.commands.create_product.handler import (
    CreateProductHandler,
)
from app.modules.catalog.application.features.product.commands.delete_product.command import (
    DeleteProductCommand,
)
from app.modules.catalog.application.features.product.commands.delete_product.endpoint import (
    router as delete_product_router,
)
from app.modules.catalog.application.features.product.commands.delete_product.handler import (
    DeleteProductHandler,
)
from app.modules.catalog.application.features.product.commands.update_product.command import (
    UpdateProductCommand,
)
from app.modules.catalog.application.features.product.commands.update_product.endpoint import (
    router as update_product_router,
)
from app.modules.catalog.application.features.product.commands.update_product.handler import (
    UpdateProductHandler,
)
from app.modules.catalog.application.features.product.queries.get_product_by_id.endpoint import (
    router as get_product_by_id_router,
)
from app.modules.catalog.application.features.product.queries.get_product_by_id.handler import (
    GetProductByIdHandler,
)
from app.modules.catalog.application.features.product.queries.get_product_by_id.query import (
    GetProductByIdQuery,
)
from app.modules.catalog.application.features.product.queries.get_products.endpoint import (
