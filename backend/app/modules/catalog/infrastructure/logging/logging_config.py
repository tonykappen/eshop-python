...
class CatalogLoggingConfig(BaseSettings):
    ...
    log_to_console: bool = Field(
        default=True, alias="CATALOG_LOG_TO_CONSOLE", description="Log to console"
    )

    log_to_file: bool = Field(
        default=False, alias="CATALOG_LOG_TO_FILE", description="Log to file"
    )
    ...
    enable_seq: bool = Field(
        default=False, alias="CATALOG_ENABLE_SEQ", description="Enable Seq logging"
    )
    ...
    datadog_api_key: str = Field(
        default="", alias="CATALOG_DATADOG_API_KEY", description="Datadog API key"
    )
