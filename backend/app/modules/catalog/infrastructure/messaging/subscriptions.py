...
class DomainEventSubscriptions:
    ...
    def _setup_product_subscriptions(self) -> None:
        ...
        if self.event_publisher:
            product_created_integration_handler = PublishProductCreatedIntegrationEventHandler(
    ...
    def _setup_category_subscriptions(self) -> None:
        ...
        domain_event_dispatcher.register_handler(CategoryCreatedDomainEvent, category_created_handler)
    ...
    def _setup_inventory_subscriptions(self) -> None:
        ...
        domain_event_dispatcher.register_handler(StockAdjustedDomainEvent, stock_adjusted_handler)
        
        # Stock adjusted integration event handler
        if self.event_publisher:
            stock_adjusted_integration_handler = ReactToStockAdjustedIntegrationEventHandler()
            domain_event_dispatcher.register_handler(
                StockAdjustedDomainEvent,
                stock_adjusted_integration_handler.handle
            )
