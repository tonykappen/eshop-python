...
class InventoryItemORM(Base):
    ...
    # Product reference
    product_id: Mapped[UUID] = mapped_column(PostgresUUID(as_uuid=True), nullable=False, unique=True)
    
    # Inventory information
    quantity: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    reserved_quantity: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    reorder_threshold: Mapped[int] = mapped_column(Integer, nullable=False, default=10)
    max_stock_threshold: Mapped[int] = mapped_column(Integer, nullable=False, default=1000)
