...
class ProductRepositoryImpl(ProductRepository):
    ...
    async def get_by_id(self, product_id: UUID) -> Product | None:
        ...
        try:
            stmt = select(ProductORM).where(
                ProductORM.id == product_id, ProductORM.is_deleted is False
            )
    ...
    async def get_deleted_by_id(self, product_id: UUID) -> Product | None:
        ...
        try:
            stmt = select(ProductORM).where(
                ProductORM.id == product_id, ProductORM.is_deleted is True
            )
            result = await self.session.execute(stmt)
            product_orm = result.scalar_one_or_none()
    ...
    async def get_by_sku(self, sku: str) -> Product | None:
        ...
        try:
            stmt = select(ProductORM).where(
                ProductORM.sku == sku, ProductORM.is_deleted is False
            )
            result = await self.session.execute(stmt)
            product_orm = result.scalar_one_or_none()
    ...
    async def get_by_name(self, name: str) -> Product | None:
        ...
        try:
            stmt = select(ProductORM).where(
                ProductORM.name == name, ProductORM.is_deleted is False
            )
            result = await self.session.execute(stmt)
            product_orm = result.scalar_one_or_none()
        ...
        try:
            ...
            if page != 1 or page_size != 10:
                ...
                count_stmt = select(func.count(ProductORM.id)).where(
                    ...
                    ProductORM.is_deleted is False,
                )
    ...
    async def delete(
        ...
        try:
            ...
            stmt = (
                update(ProductORM)
                .where(ProductORM.id == product_id, ProductORM.is_deleted is False)
                .values(
                    is_deleted=True,
    ...
    async def get_all(
        ...
        try:
            ...
            stmt = (
                select(ProductORM)
                .where(ProductORM.is_deleted is False)
                .offset(offset)
                .limit(page_size)
                .order_by(ProductORM.created_at.desc())
            )
    ...
    async def get_deleted_products(
        ...
        try:
            ...
            stmt = (
                select(ProductORM)
                .where(ProductORM.is_deleted is True)
                .offset(offset)
                .limit(page_size)
                .order_by(
    ...
    async def restore_product(
        ...
        try:
            stmt = (
                update(ProductORM)
                .where(ProductORM.id == product_id, ProductORM.is_deleted is True)
                .values(
                    is_deleted=False,
                    deleted_at=None,
                    deleted_by=None,
