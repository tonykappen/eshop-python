...
class TestConvenienceFunctions:
    ...
    def test_map_to_dto_function(self) -> None:
        ...
        with patch("app.core.mapping.mapper.MsgspecMapper.map_to_dto") as mock_mapper:
            mock_dto = TestDTO(id=1, name="test")
    ...
    def test_map_to_entity_function(self) -> None:
        ...
        with patch(
            "app.core.mapping.mapper.MsgspecMapper.map_to_entity"
        ) as mock_mapper:
    ...
    def test_map_list_to_dtos_function(self) -> None:
        ...
        with patch(
            "app.core.mapping.mapper.MsgspecMapper.map_list_to_dtos"
        ) as mock_mapper:
    ...
    def test_map_list_to_entities_function(self) -> None:
        ...
        with patch(
            "app.core.mapping.mapper.MsgspecMapper.map_list_to_entities"
        ) as mock_mapper:
    ...
    def test_to_json_function(self) -> None:
        ...
        with patch("app.core.mapping.mapper.MsgspecMapper.to_json") as mock_mapper:
    ...
    def test_from_json_function(self) -> None:
        ...
        with patch("app.core.mapping.mapper.MsgspecMapper.from_json") as mock_mapper:
            mock_dto = TestDTO(id=1, name="test")
            mock_mapper.return_value = mock_dto
    ...
    def test_to_redis_function(self) -> None:
        ...
        with patch("app.core.mapping.mapper.MsgspecMapper.to_redis") as mock_mapper:
    ...
    def test_from_redis_function(self) -> None:
        ...
        with patch("app.core.mapping.mapper.MsgspecMapper.from_redis") as mock_mapper:
            mock_dto = TestDTO(id=1, name="test")
            mock_mapper.return_value = mock_dto
