...
def run_tests(
    test_pattern: str = "test_catalog*", verbose: bool = True, coverage: bool = False
) -> int:
    ...
    cmd.extend(["--strict-markers", "--disable-warnings", "--color=yes"])
...
def main() -> int:
    ...
    parser.add_argument(
        "--categories", action="store_true", help="Run specific test categories"
    )
