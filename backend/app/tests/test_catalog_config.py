...
def mock_async_session_local():
    ...
    with patch('app.modules.catalog.application.handlers.create_product_handler.AsyncSessionLocal') as mock:
...
def mock_product_repository_class():
    ...
    with patch('app.modules.catalog.application.handlers.create_product_handler.ProductRepository') as mock:
