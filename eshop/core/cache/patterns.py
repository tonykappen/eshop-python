...
class CacheAsidePattern:
    ...
    async def invalidate_and_refetch(self, key: str, fetch_func, ttl: Optional[int] = None) -> Any:
...
class CacheInvalidationPattern:
    ...
    async def invalidate_related_data(self, entity_type: str, entity_id: UUID, related_types: list[str]) -> None:
