...
class ProductCreatedIntegrationEvent(CatalogIntegrationEvent):
    ...
    # topic: "eshop.catalog.product_created"
    # routing_key: "eshop.catalog.product_created"
...
class ProductPriceChangedIntegrationEvent(CatalogIntegrationEvent):
    ...
    # topic: "eshop.catalog.product_price_changed"
    # routing_key: "eshop.catalog.product_price_changed"
...
class ProductInventoryUpdatedIntegrationEvent(CatalogIntegrationEvent):
    ...
    # topic: "eshop.catalog.product_inventory_updated"
    # routing_key: "eshop.catalog.product_inventory_updated"
...
class ProductDiscontinuedIntegrationEvent(CatalogIntegrationEvent):
    ...
    # topic: "eshop.catalog.product_discontinued"
