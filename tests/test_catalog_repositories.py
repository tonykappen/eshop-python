...
from eshop.modules.catalog.infrastructure.repositories import (
...
class TestCatalogItemRepository:
    ...
    async def test_get_by_id_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
    ...
    async def test_get_all_success(self) -> None:
        ...
        mock_orm_items = [MagicMock(spec=CatalogItemORM), MagicMock(spec=CatalogItemORM)]
        mock_result = MagicMock()
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            mock_domain_items = [MagicMock(spec=CatalogItem), MagicMock(spec=CatalogItem)]
            ...
            mock_session.execute.assert_called_once()
            mock_mapper.from_orm_list.assert_called_once_with(mock_orm_items, CatalogItem)
    ...
    async def test_update_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            assert result == mock_domain_item
            mock_session.execute.assert_called_once()
            mock_mapper.update_orm_from_domain.assert_called_once_with(mock_orm_item, mock_domain_item)
...
class TestCatalogCategoryRepository:
    ...
    async def test_get_by_id_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            mock_session.execute.assert_called_once()
            mock_mapper.from_orm.assert_called_once_with(mock_orm_category, CatalogCategory)
    ...
    async def test_get_all_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            mock_session.execute.assert_called_once()
            mock_mapper.from_orm_list.assert_called_once_with(mock_orm_categories, CatalogCategory)
    ...
    async def test_add_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            assert result == mock_domain_category
            mock_mapper.to_orm.assert_called_once_with(mock_domain_category, CatalogCategoryORM)
    ...
    async def test_update_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            assert result == mock_domain_category
            mock_session.execute.assert_called_once()
            mock_mapper.update_orm_from_domain.assert_called_once_with(mock_orm_category, mock_domain_category)
            # The update method calls from_orm with the result of update_orm_from_domain
            mock_mapper.from_orm.assert_called_once()
...
class TestCatalogBrandRepository:
    ...
    async def test_get_all_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            mock_session.execute.assert_called_once()
            mock_mapper.from_orm_list.assert_called_once_with(mock_orm_brands, CatalogBrand)
    ...
    async def test_add_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            assert result == mock_domain_brand
            mock_mapper.to_orm.assert_called_once_with(mock_domain_brand, CatalogBrandORM)
    ...
    async def test_update_success(self) -> None:
        ...
        with patch("eshop.modules.catalog.infrastructure.repositories.ORMMapper") as mock_mapper:
            ...
            assert result == mock_domain_brand
            mock_session.execute.assert_called_once()
            mock_mapper.update_orm_from_domain.assert_called_once_with(mock_orm_brand, mock_domain_brand)
            # The update method calls from_orm with the result of update_orm_from_domain
            mock_mapper.from_orm.assert_called_once()
