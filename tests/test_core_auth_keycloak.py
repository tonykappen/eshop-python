...
from eshop.core.auth.keycloak import (
    KeycloakService,
    KeycloakUser,
    add_keycloak_routes,
    get_current_user,
...
class TestKeycloakService:
    ...
    @patch("eshop.core.auth.keycloak.FastAPIKeycloak")
    @patch("eshop.core.auth.keycloak.settings")
...
class TestAuthDependencies:
    ...
    async def test_require_role_success(self) -> None:
        ...
        with (
            patch("eshop.core.auth.keycloak.get_current_user", return_value=mock_user),
...
class TestKeycloakIntegration:
    ...
    @patch("eshop.core.auth.keycloak.keycloak_service")
