...
from eshop.core.di.assembly_scanner import (
    AssemblyScanner,
    function_service,
    service,
    singleton_service,
...
from eshop.core.di.container import (
    Container,
    ServiceProvider,
    configure_container,
    create_container,
...
class TestAssemblyScanner:
    ...
    def test_scan_package_success(self) -> None:
        ...
        with patch("eshop.core.di.assembly_scanner.importlib.import_module") as mock_import:
    ...
    def test_scan_directory_success(self) -> None:
        ...
        with patch("eshop.core.di.assembly_scanner.Path") as mock_path:
    ...
    def test_discover_services_in_module(self) -> None:
        ...
        with patch.object(scanner, "_register_service") as mock_register_service:
            ...
            assert mock_register_service.call_count >= 0  # May or may not register depending on patterns
    ...
    def test_is_service_function_without_service_pattern(self) -> None:
        ...
        regular_function.__module__ = "eshop.test.module"
    ...
    def test_register_service(self) -> None:
        ...
        with patch.object(scanner, "_determine_scope") as mock_scope, patch.object(scanner, "_create_provider") as mock_provider:
    ...
    def test_register_function_service(self) -> None:
        ...
        with patch("eshop.core.di.assembly_scanner.providers") as mock_providers:
            mock_callable = MagicMock()
            mock_providers.Callable.return_value = mock_callable
            
            scanner._register_function_service("test_function", test_function, "test.module")
...
class TestContainer:
    ...
    def test_create_container(self) -> None:
        ...
        with patch("eshop.core.di.container.Container") as mock_container_class:
            mock_container = create_mock_container()
    ...
    def test_scan_assemblies_success(self) -> None:
        ...
        with patch("eshop.core.di.container.logger") as mock_logger:
    ...
    def test_get_container(self) -> None:
        ...
        with patch("eshop.core.di.container.create_container") as mock_create:
            mock_container = create_mock_container()
