...
class TestDatabaseLifecycleHandler:
    ...
    @patch("eshop.core.lifecycle.handlers.create_db_engine")
    @patch("eshop.core.lifecycle.handlers.run_migrations")
    @patch("eshop.core.lifecycle.handlers.run_seeding")
    ...
    @patch("eshop.core.lifecycle.handlers.close_db_engine")
...
class TestCacheLifecycleHandler:
    ...
    async def test_startup_failure(self) -> None:
        ...
        with patch.object(handler, "_verify_cache_connectivity", side_effect=Exception("Cache failed")):
...
class TestMessagingLifecycleHandler:
    ...
    async def test_startup_failure(self) -> None:
        ...
        # Mock the connectivity check to fail
        with patch.object(handler, "_verify_messaging_connectivity", side_effect=Exception("Messaging failed")):
...
class TestAuthenticationLifecycleHandler:
    ...
    async def test_startup_failure(self) -> None:
        ...
        # Mock the connectivity check to fail
        with patch.object(handler, "_verify_auth_connectivity", side_effect=Exception("Auth failed")):
...
class TestHealthCheckLifecycleHandler:
    ...
    @patch("eshop.core.lifecycle.handlers.health_service")
    ...
    async def test_startup_failure(self) -> None:
        ...
        with patch.object(handler, "_perform_initial_health_check", side_effect=Exception("Health failed")):
    ...
    async def test_shutdown_failure(self) -> None:
        ...
        with patch.object(handler, "_perform_initial_health_check", side_effect=Exception("Shutdown failed")):
            # Should not raise exception
            await handler.shutdown()
    ...
    async def test_perform_initial_health_check_failure(self) -> None:
        ...
        handler = HealthCheckLifecycleHandler()
        handler.health_service = MagicMock()
        handler.health_service.check_all_services = AsyncMock(side_effect=Exception("Health check failed"))
...
class TestLifecycleHandlersIntegration:
    ...
    async def test_concurrent_startup(self) -> None:
        ...
        with patch("eshop.core.lifecycle.handlers.create_db_engine"), \
             patch("eshop.core.lifecycle.handlers.run_migrations"), \
             patch("eshop.core.lifecycle.handlers.run_seeding"), \
             patch("eshop.core.lifecycle.handlers.health_service"):
    ...
    async def test_error_recovery(self) -> None:
        ...
        with patch.object(database_handler, "startup", side_effect=Exception("DB failed")):
