...
from eshop.core.logging.logger import (
    AutoLogContext,
    LoggerMixin,
    configure_logging,
    get_logger,
...
from eshop.core.logging.request_logging import (
...
class TestRequestLoggingMiddleware:
    ...
    async def test_middleware_logs_successful_request(self) -> None:
        ...
        with patch("eshop.core.logging.request_logging.logger") as mock_logger:
            middleware = RequestLoggingMiddleware(mock_app)
