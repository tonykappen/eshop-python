...
from backend.app.core.auth.keycloak import KeycloakUser
...
class TestMainApplication:
    ...
    @patch("backend.app.main.get_logger")
    @patch("backend.app.main.configure_logging")
    @pytest.mark.asyncio
    async def test_configure_application_startup(
        ...
        from backend.app.main import configure_application_startup
    ...
    @patch("backend.app.main.settings")
    @patch("backend.app.main.get_logger")
    @patch("backend.app.main.create_container")
    @patch("backend.app.main.scan_assemblies")
    @patch("backend.app.main.wire_container")
    @pytest.mark.asyncio
    async def test_initialize_dependency_injection(
        ...
        from backend.app.main import initialize_dependency_injection
    ...
    @patch("backend.app.main.get_logger")
    @patch("backend.app.main.configure_mediator")
    @pytest.mark.asyncio
    async def test_initialize_mediator(
        ...
        from backend.app.main import initialize_mediator
    ...
    async def test_cleanup_dependency_injection(
        ...
        from backend.app.main import cleanup_dependency_injection
    ...
    @patch("backend.app.main.lifecycle_manager")
    @pytest.mark.asyncio
    ...
    @patch("backend.app.main.health_service")
    @pytest.mark.asyncio
...
class TestMainIntegration:
    ...
    def test_global_container_reference(self) -> None:
        ...
        from backend.app.main import _app_container
